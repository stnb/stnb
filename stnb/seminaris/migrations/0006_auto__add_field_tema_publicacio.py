...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tema.publicacio'
        db.add_column('seminaris_tema', 'publicacio',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='temes', null=True, to=orm['publicacions.Publicacio']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tema.publicacio'
        db.delete_column('seminaris_tema', 'publicacio_id')
    ...
    models = {
        ...
        'seminaris.seminari': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'organitzadors': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'seminaris'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['membres.Membre']"}),
            'programa_pdf': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'publicacio': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'seminaris'", 'null': 'True', 'to': "orm['publicacions.Publicacio']"}),
        ...
        'seminaris.tema': {
            ...
            'publicacio': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'temes'", 'null': 'True', 'to': "orm['publicacions.Publicacio']"}),
