...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Seminari.publicacio'
        db.add_column('seminaris_seminari', 'publicacio',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='seminaris', null=True, to=orm['publicacions.Publicacio']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Seminari.publicacio'
        db.delete_column('seminaris_seminari', 'publicacio_id')
