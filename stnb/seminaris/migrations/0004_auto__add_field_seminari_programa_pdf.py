...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Seminari.programa_pdf'
        db.add_column('seminaris_seminari', 'programa_pdf',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Seminari.programa_pdf'
        db.delete_column('seminaris_seminari', 'programa_pdf')
